...
const Item = () => (
  <div className="col-md-5 my-2 border-left border-top">
    <div className="row justify-content-center mt-5 ">
      ...
      <div className="col-6 item_prix_text text-center my-2"><p className="text-center py-2 h4">Prix</p></div>
      <div className="col-6 item_prix_number py-2"><p className="text-center py-2 h4">12€</p></div>
    </div>
  </div>
);
export default Item;
